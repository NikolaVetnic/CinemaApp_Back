...
('1', 'Predator', 'Dutch and his team are out on a mission to rescue a group of hostages in Central America. There, they discover that they are being targeted by an extraterrestrial warrior.', 'https://upload.wikimedia.org/wikipedia/en/9/95/Predator_Movie.jpg', 'https://www.youtube.com/watch?v=X2hBYGwKh3I', '107');
INSERT INTO `pris_cinema`.`movie` (`id`, `title`, `description`, `image`, `trailer`, `runtime`) VALUES
('2', 'Predator 2', 'Predator 2 is a 1990 American science fiction action film[3] written by brothers Jim and John Thomas, directed by Stephen Hopkins, and starring Danny Glover, Ruben Blades, Gary Busey, María Conchita Alonso, Bill Paxton, and Kevin Peter Hall.', 'https://upload.wikimedia.org/wikipedia/en/b/b5/Predator_two.jpg', 'https://www.youtube.com/watch?v=X2hBYGwKh3I', '108');
INSERT INTO `pris_cinema`.`movie` (`id`, `title`, `description`, `image`, `trailer`, `runtime`) VALUES
('3', 'The Matrix', 'The Matrix is a 1999 science fiction action film[5][6] written and directed by the Wachowskis.', 'https://upload.wikimedia.org/wikipedia/en/c/c1/The_Matrix_Poster.jpg', 'https://www.youtube.com/watch?v=X2hBYGwKh3I', '136');
INSERT INTO `pris_cinema`.`movie` (`id`, `title`, `description`, `image`, `trailer`, `runtime`) VALUES
('4', 'Dune', 'In the year 10191, a spice called melange is the most valuable substance known in the universe, and its only source is the desert planet Arrakis. ', 'https://upload.wikimedia.org/wikipedia/en/5/51/Dune_1984_Poster.jpg', 'https://www.youtube.com/watch?v=X2hBYGwKh3I', '137');
